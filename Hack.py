...
app = Client('admin', api_id=21595595, api_hash='4f254e2cf003f527f94da5109d17b332')
...
print(Fore.GREEN + Style.BRIGHT + ">>> Информация: https://teletype.in/@emptyhead/yNy-UcQxW4i ")
print(Fore.YELLOW + Style.BRIGHT +"Напишите в любой телеграм чат команду -help, \nдля просмотра всех команд!")
print("\nАвтор скрипта -\nTelegram: @EmptyHead_PlayBoy\n")
...
📙<b> Команды:</b> \n<b> - https://teletype.in/@emptyhead/yNy-UcQxW4i</b> \n 
➡️<b> Версия: 1.0</b> \n
💎 <b>Приобрести PREMIUM анимацию: </b>\n <b>- А нахуя тебе премиум анимация, покупай у меня, пиши @EmptyHead_PlayBoy</b> \n
...
def mems(app, msg):
	...
	Автор скрипта: @EmptyHead_PlayBoy
		''')
	global number
	number = number + 1
...
def betaloves(_, msg):
	...
	if hack >= 99:
		...
		sleep(0.6)
		msg.edit(f'''
		Чат успешно взломан! Все данные отправятся в облоко EHOB.''')
